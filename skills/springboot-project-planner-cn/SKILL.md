---
name: springboot-project-planner-cn
description: Spring Boot 项目规划助手，全面沟通需求并生成架构设计和实施计划
---

# Spring Boot 项目规划助手

当你需要启动一个新的 Spring Boot 项目或对现有项目进行重大改进时使用此技能。通过系统化的沟通，帮助你全面了解需求，设计架构，制定实施计划。
